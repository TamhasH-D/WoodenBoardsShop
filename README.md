...
### 🆕 Новинка: Реальный YOLO анализ в генераторе данных!
- 🚀 **Генератор данных v4.0** с интеграцией YOLO нейросети
- 📏 **Точные измерения** объема досок на основе реального анализа изображений
- 🎯 **Автоматическое создание** товаров с корректными данными
- ⚡ **Асинхронная обработка** изображений для высокой производительности
- 📋 Подробнее: `data-generator/YOLO_INTEGRATION_SUMMARY.md`
