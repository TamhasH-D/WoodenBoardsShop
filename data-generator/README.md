# 📊 Генератор синтетических данных (Улучшенная версия)

Мощная система для заполнения базы данных WoodenBoardsShop большим количеством реалистичных синтетических данных с поддержкой различных профилей генерации и расширенными возможностями.
...
6. **🖼️ Изображения** (2,500 записей)
   - Копируются из benchmarks
   - Привязываются к товарам
   - Сохраняются в папке uploaded_images

7. **🪵 Записи досок** (5,000-10,000 записей)
   - 1-4 доски на изображение
   - 54 стандартных размера досок
   - 26 различных длин от 1м до 12м
