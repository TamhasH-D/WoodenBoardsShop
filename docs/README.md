...
### Frontend компоненты:
- **Admin Frontend** (React, порт 8080) - административная панель
- **Seller Frontend** (React, порт 8081) - интерфейс продавца
- **Buyer Frontend** (React, порт 8082) - интерфейс покупателя

### Backend компоненты:
- **Backend API** (FastAPI, порт 8000) - основной API
- **AI Microservice** (FastAPI, порт 8001) - анализ изображений

### Инфраструктура:
- **PostgreSQL** - основная база данных
- **Keycloak** - система аутентификации
