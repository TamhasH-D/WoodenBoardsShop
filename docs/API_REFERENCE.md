...
POST   /api/v1/products/with-analysis  # Создание товара с AI анализом
...
**Особенность**: endpoint `/products/with-analysis` интегрирован с AI микросервисом для автоматического анализа изображений досок.
...
### Анализ объема досок
Endpoint `/products/with-analysis` автоматически:
...
```http
POST /api/v1/products/with-analysis
