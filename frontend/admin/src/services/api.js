...
export const apiService = {
  ...
  async createProduct(productData) {
    // ID is auto-generated by the backend, uses 'descrioption' (typo in backend)
    const payload = {
  ...
  async createWoodType(woodTypeData) {
    // ID is auto-generated by the backend, uses 'neme' field (typo in backend)
    const payload = {
  ...
  async createWoodenBoard(boardData) {
    // ID is auto-generated by the backend, uses 'lenght' (typo in backend)
    const payload = {
      height: parseFloat(boardData.height),
      width: parseFloat(boardData.width),
      lenght: parseFloat(boardData.length || boardData.lenght), // Handle backend typo
  ...
  async createChatMessage(messageData) {
    // Backend requires 'id' field for chat message creation
    const payload = {
      id: crypto.randomUUID(), // Generate UUID for new chat message
  ...
  async getSystemAnalytics() {
    try {
      // Fetch complete datasets for accurate analytics using pagination utilities
      const [buyers, sellers, products, woodTypes, prices, boards, images, threads, messages] = await Promise.all([
        this.getAllBuyers(),
        this.getAllSellers(),
        this.getAllProducts(),
        this.getAllWoodTypes(),
        this.getAllWoodTypePrices(),
        this.getAllWoodenBoards(),
        this.getAllImages(),
        this.getAllChatThreads(),
