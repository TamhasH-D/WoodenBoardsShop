...
const CommunicationPage = () => {
  ...
  const tabs = [
    { 
      ...
      description: 'Управление чат-тредами между покупателями и продавцами'
    },
    { 
      key: 'messages', 
      label: 'Сообщения', 
      ...
      description: 'Модерация сообщений и контент-фильтрация'
    },
  ];
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-semibold text-gray-900">Коммуникации</h1>
        <p className="mt-1 text-sm text-gray-600">
          Управление чатами, модерация сообщений и мониторинг коммуникаций между пользователями
        </p>
      </div>
