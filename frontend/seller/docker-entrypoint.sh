...
REACT_APP_OIDC_AUTHORITY="${KEYCLOAK_PROTOCOL}://${CURRENT_KEYCLOAK_HOST}${KEYCLOAK_PORT_SUFFIX}/realms/Seller"
REACT_APP_OIDC_CLIENT_ID="seller"
...
export REACT_APP_API_URL="${PROTOCOL}://${PRODUCTION_API_HOST:-api.taruman.ru}"
export REACT_APP_WOODEN_BOARDS_API_URL="${PROTOCOL}://${PRODUCTION_API_HOST:-api.taruman.ru}"
...
window._env_ = {
  ...
  REACT_APP_API_URL: "${PROTOCOL}://${PRODUCTION_API_HOST:-api.taruman.ru}",
  REACT_APP_WOODEN_BOARDS_API_URL: "${PROTOCOL}://${PRODUCTION_API_HOST:-api.taruman.ru}"
};
EOF
